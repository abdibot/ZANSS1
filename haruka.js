...
const starts = async (haruka = new WAConnection()) => {
    ...
    haruka.browserDescription = [ 'ZANSS OFC', 'Google', 'V1' ]
	CFonts.say('ZANSS OFC', {
		font: 'block',
    	color: ['#ff9c00'],
    	align: 'center',
		})
	CFonts.say(`Bot WhatsApp Created By Zanss OFC`, {
		font: 'console',
		align: 'center',
    ...
    haruka.on('open', () => {
        success('2', 'Connected Bg Jangan Lupa SUBSCRIBE ZANSS OFC')
    })
